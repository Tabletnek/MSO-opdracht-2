...
namespace MSO_Opdracht_3
{
    ...
    public class FileTranslator
    {
        ...
        public TaskProgram TranslateFile(string filePath)
        {
        ...
        public TaskProgram TranslateProgram(StreamReader sr, int nestedLoops)
        {

            TaskProgram program = new TaskProgram(size);
            while (line != null)
            {
